...
- **ที่มา:** ต่อยอดจาก v2.0.0 (สะอาด) — แก้บั๊กฟิลเตอร์เดือน + ดึงงานรองรับไฟล์ (v2.2.1/2.2.2) กลับมา
  โดย**ไม่เอา** dense/multi-file ที่ทำให้รู้สึก "มั่ว" กลับมา
...
### 2) ดึงงานรองรับไฟล์กลับมา (จาก v2.2.1 + v2.2.2)
...
- **ไม่รวม** dense mode (v2.2.3) และ multi-file (v2.2.0) — ยังอัปทีละไฟล์เหมือน v2.0.0
